<template>
  <el-tabs type="border-card" v-model="objData.repType" @tab-click="handleClick">
    <el-tab-pane name="text">
      ...
      <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="objData.repContent"></el-input>
    </el-tab-pane>
      ...
      <el-row>
        <div class="select-item2" v-if="objData.repName">
          ...
          <div class="item-infos">
            <WxVoicePlayer
              :objData="Object.assign(tempPlayerObj,{repMediaId: objData.media_id, repName: objData.repName})"
            ></WxVoicePlayer>
          </div>
          <el-row class="ope-row">
            <el-button type="danger" icon="el-icon-delete" circle @click="deleteObj"></el-button>
      ...
      <el-row>
        ...
        <div style="text-align: center;">
          <a target="_blank" v-if="objData.repUrl" :href="objData.repUrl">
            <i class="icon-shipinbofang">&nbsp;播放视频</i>
          </a>
        </div>
        <div style="margin: 20px 0;"></div>
        <div style="text-align: center">
...
export default {
  ...
  data() {
    return {
      ...
      actionUrl:
        process.env.VUE_APP_BASE_API + '/wxmaterial/materialFileUpload',
      headers: {
  ...
  methods: {
    ...
    handleClick(tab, event) {
      ...
      if (tempObjItem) {
        ...
        this.objData.repMediaId = tempObjItem.repMediaId
          ? tempObjItem.repMediaId
          : null
        this.objData.media_id = tempObjItem.media_id
          ? tempObjItem.media_id
          : null
