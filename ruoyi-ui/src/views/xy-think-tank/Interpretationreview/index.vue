    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          size="mini"
          @click="resetparam('0')"
          v-hasPermi="['thinkTank:interpret:batch']"
        >批量通过</el-button>
        <!-- <el-button
          :disabled="single"
          type="danger"
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-check"
            v-hasPermi="['thinkTank:interpret:approval']"
...
import {
  ...
  updetapolicyReviews,
  getInterpret,
} from '@/api/xy-think-tank/lnterpretationReview'
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      updetapolicyReview(add).then((response) => {
        this.$modal.msgSuccess('审核成功')
        this.opentwo = false
