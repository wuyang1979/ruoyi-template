      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-check"
            v-hasPermi="['xyNews:news:approval']"
