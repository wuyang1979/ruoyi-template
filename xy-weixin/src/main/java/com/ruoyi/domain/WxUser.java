...
import com.ruoyi.sensitive.Sensitive;
import com.ruoyi.sensitive.SensitiveTypeEnum;
import com.ruoyi.typehandler.ArrayLongTypeHandler;
import lombok.Data;
 ...
 */
@Data
@TableName(value = "xy_wx_user", autoResultMap = true)
